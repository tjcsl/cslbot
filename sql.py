...
class Sql():
    ...
    def setup_db(self):
        ...
        db.execute('CREATE TABLE IF NOT EXISTS polls(question TEXT, active INTEGER, deleted INTEGER, id INTEGER PRIMARY KEY AUTOINCREMENT)')
        db.execute('CREATE TABLE IF NOT EXISTS poll_responses(qid INTEGER, response TEXT, voter TEXT, id INTEGER PRIMARY KEY AUTOINCREMENT)')
