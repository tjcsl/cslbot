...
def revision(config, message=None, autogenerate=False, sql=False, head='', splice=False, branch_label=None, version_path=None, rev_id=None, depends_on=None): ...
def merge(config, revisions, message=None, branch_label=None, rev_id=None): ...
def upgrade(config: Config, revision: str, sql=False, tag: str = None) -> None: ...
