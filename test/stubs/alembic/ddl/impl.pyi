...
class DefaultImpl:
    ...
    def alter_column(self, table_name: Any, column_name: Any, nullable: Optional[Any] = ..., server_default: bool = ..., name: Optional[Any] = ..., type_: Optional[Any] = ..., schema: Optional[Any] = ..., autoincrement: Optional[Any] = ..., comment: bool = ..., existing_comment: Optional[Any] = ..., existing_type: Optional[Any] = ..., existing_server_default: Optional[Any] = ..., existing_nullable: Optional[Any] = ..., existing_autoincrement: Optional[Any] = ...) -> None: ...
