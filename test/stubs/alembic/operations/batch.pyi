...
class BatchOperationsImpl:
    ...
    def __init__(self, operations: Any, table_name: Any, schema: Any, recreate: Any, copy_from: Any, table_args: Any, table_kwargs: Any,
                 reflect_args: Any, reflect_kwargs: Any, naming_convention: Any) -> None:
        ...
