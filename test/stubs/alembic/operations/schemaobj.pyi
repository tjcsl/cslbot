...
class SchemaObjects:
    ...
    def foreign_key_constraint(self, name: Any, source: Any, referent: Any, local_cols: Any, remote_cols: Any, onupdate: Optional[Any] = ..., ondelete: Optional[Any] = ..., deferrable: Optional[Any] = ..., source_schema: Optional[Any] = ..., referent_schema: Optional[Any] = ..., initially: Optional[Any] = ..., match: Optional[Any] = ..., **dialect_kw: Any): ...
