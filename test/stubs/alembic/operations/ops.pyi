...
class DropConstraintOp(MigrateOperation):
    ...
    def __init__(self,
                 ...
                 type_: Optional[Any] = ...,
                 schema: Optional[Any] = ...,
                 _orig_constraint: Optional[Any] = ...) -> None:
        ...
...
class CreateForeignKeyOp(AddConstraintOp):
    ...
    @classmethod
    def batch_create_foreign_key(cls,
                                 operations: Any,
                                 constraint_name: Any,
                                 referent_table: Any,
                                 local_cols: Any,
...
class CreateIndexOp(MigrateOperation):
    ...
    @classmethod
    def create_index(cls, operations: Any, index_name: Any, table_name: Any, columns: Any, schema: Optional[Any] = ..., unique: bool = ...,
                     **kw: Any):
        ...
...
class DropIndexOp(MigrateOperation):
    ...
    def __init__(self, index_name: Any, table_name: Optional[Any] = ..., schema: Optional[Any] = ..., _orig_index: Optional[Any] = ...,
                 **kw: Any) -> None:
        ...
...
class AlterColumnOp(AlterTableOp):
    ...
    def __init__(self,
                 ...
                 existing_server_default: bool = ...,
                 existing_nullable: Optional[Any] = ...,
                 existing_comment: Optional[Any] = ...,
                 modify_nullable: Optional[Any] = ...,
                 modify_comment: bool = ...,
                 modify_server_default: bool = ...,
                 modify_name: Optional[Any] = ...,
                 modify_type: Optional[Any] = ...,
                 **kw: Any) -> None:
        ...
