...
def resource_filename(package_or_requirement: Requirement, resource_name: str) -> str: ...
def resource_string(package_or_requirement: Requirement, resource_name: str) -> bytes: ...
