# Stubs for unittest.mock (Python 3.5)
#
...
class patch:
    ...
    def __init__(target, new=..., spec=None, create=False, spec_set=None, autospec=None, new_callable=None, **kwargs) -> None: ...
    def copy(self): ...
    ...
    def stop(self): ...
    @staticmethod
    def object(target, *args, **kwargs) -> target: ...
    @staticmethod
    def dict(target, *args, **kwargs) -> target: ...
