...
class ServerSpec:
    ...
    port = ...  # type: Any
    password = ...  # type: Any
    def __init__(self, host: str, port: int = 6667, password: str = None) -> None: ...
...
class SingleServerIRCBot(irc.client.SimpleIRCClient):
    ...
    recon = ...  # type: Any
    def __init__(self, server_list: List[ServerSpec], nickname: str, realname: str, reconnection_interval=..., recon=..., **connect_params) -> None: ...
    def die(self, msg=''): ...
