...
def cmd(send, msg, args):
	spaces = ["\"Still Alive\" on piano", "polo shirt", "workstation broken", "man man", "csssuf on deadtom",
	          ...
	          "pit stains", "jcotton's ipad", "diet coke", "booting itanium",
	          ...
	          "ahamilto's laugh", "<creffett> zan--", "xscreensaver bug", "shibe", "no shibing"]
  ...
  nick = args['nick']
	...
	c.privmsg("------------------------------")
	c.privmsg("Make a real bingo board here: http://i.imgur.com/0Z3dxKw.png")
