...
def upgrade():
    op.create_table(
        ...
        sa.Column(
            'key', sa.Unicode(length=512), nullable=True),
        sa.Column(
            'source', sa.UnicodeText(), nullable=True),
        sa.Column(
            'target', sa.UnicodeText(), nullable=True),
        sa.Column(
            'word', sa.UnicodeText(), nullable=True),
        sa.Column(
            'freq', sa.Integer(), nullable=True),
