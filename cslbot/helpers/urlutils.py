...
def get_short(msg, key):
    ...
    req = requests.get(
        ...
        params={"access_token": key, "longUrl": msg, "format": "txt"},
    )
    link = req.text.strip()
    ...
    with contextlib.closing(requests.Session()) as session:
        ...
        try:
            ...
            # 405/409/501 mean this site doesn't support HEAD
                ...
                requests.codes.not_allowed, requests.codes.conflict, requests.codes.not_implemented
            ]:
